...
@Component({
    ...
    template: `
        ...
        <p>Add <strong>nzFormControlValidation</strong> directive and error messages using predefined input values to
            form
        ...
        <dl class="row">
            ...
            <dd class="col-sm-9">Error messages for other validators. Has lower priority than more specific error
                messages
