...
@Component({
  ...
  template: `
      ...
      <p>Specify value for <strong>nzFormControlValidation</strong> directive to provide custom component which renders
      ...
      <p>Add your custom component to <strong>entryComponents</strong> of NgModule e.g. <var>src/app/app.module.ts</var>
      </p>
